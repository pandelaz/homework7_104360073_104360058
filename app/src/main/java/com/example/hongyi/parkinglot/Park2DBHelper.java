 ...
 */
public class Park2DBHelper extends SQLiteOpenHelper {
    ...
    public Park2DBHelper(Context context) {
    ...
    public boolean insertPark(Integer id, String pdata, String name) {
    ...
    public boolean updatePark(Integer id, String pdata, String name) {
        SQLiteDatabase db = this.getWritableDatabase();
        ContentValues contentValues = new ContentValues();
